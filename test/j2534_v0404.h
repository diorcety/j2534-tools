...
typedef long (J2534_API *PTCONNECT)(unsigned long DeviceID, unsigned long ProtocolID, unsigned long Flags,
                                    unsigned long BaudRate, unsigned long *pChannelID);

typedef long (J2534_API *PTDISCONNECT)(unsigned long ChannelID);

typedef long (J2534_API *PTREADMSGS)(unsigned long ChannelID, PASSTHRU_MSG *pMsg, unsigned long *pNumMsgs,
                                     unsigned long Timeout);

typedef long (J2534_API *PTWRITEMSGS)(unsigned long ChannelID, PASSTHRU_MSG *pMsg, unsigned long *pNumMsgs,
                                      unsigned long Timeout);

typedef long (J2534_API *PTSTARTPERIODICMSG)(unsigned long ChannelID, PASSTHRU_MSG *pMsg, unsigned long *pMsgID,
                                             unsigned long TimeInterval);

typedef long (J2534_API *PTSTOPPERIODICMSG)(unsigned long ChannelID, unsigned long MsgID);

typedef long (J2534_API *PTSTARTMSGFILTER)(unsigned long ChannelID, unsigned long FilterType, PASSTHRU_MSG *pMaskMsg,
...
typedef long (J2534_API *PTSETPROGRAMMINGVOLTAGE)(unsigned long DeviceID, unsigned long PinNumber,
                                                  unsigned long Voltage);

typedef long (J2534_API *PTREADVERSION)(unsigned long DeviceID, char *pFirmwareVersion, char *pDllVersion,
                                        char *pApiVersion);
